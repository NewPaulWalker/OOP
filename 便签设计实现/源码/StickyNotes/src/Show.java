    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String res =
                ...
                res +=  "\">\n" +
                        ...
                        "                   style=\"border: unset; line-height: 50px; width: 1000px;font-size: 50px; background-color: unset\" value=\"";
                res +=  request.getParameter("note");
                res +=
                        "\">\n" +
                        "            <br>\n" +
                        ...
                        "            <h1>内容：</h1>\n" +
                        "            <textarea name=\"content\" id=\"content\" style=\"width: 800px; height: 400px; margin: 0 auto; background-color: unset\">";
                String path = "D:\\StickyNotes\\notes\\";
                path += request.getParameter("note");
